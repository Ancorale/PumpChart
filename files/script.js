$(document).ready(function() {
  ...
  */
  $(`.dropdown-item`).on(`click`, function() {
    ...
    // adds 25 psi for master stream
    if (drpDnItm == `masStr`) {
      engPress = engPress + 25;
      console.log(engPress);
    }
    ...
    switch (drpDnItm) {
      ...
      default:
        ...
        */
        ...
        if (HD == `5"` && finalEP >= 185) {
          $(`#EP`)
            .html(`185 PSI Operating Pressure Exceed at ` + finalEP + ` PSI`)
            .addClass(`flashWite`);
        } else if (finalEP >= 365) {
          $(`#EP`)
            .html(`365 PSI Operating Pressure Exceed at ` + finalEP + ` PSI`)
            .addClass(`flashWite`);
        }
